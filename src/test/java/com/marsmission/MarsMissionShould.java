...
public class MarsMissionShould {
    ...
    report_single_rover_initial_position_when_no_instructions_are_provided() {
        verifyRoversFinalPositionsGivenInitialPositionsAndInstructions("5 5\n1 1 N\n", "1 1 N");
        verifyRoversFinalPositionsGivenInitialPositionsAndInstructions("5 5\n3 3 N\n", "3 3 N");
    }
    ...
    private void verifyRoversFinalPositionsGivenInitialPositionsAndInstructions(String transmission, String expectedRoverPosition) {
